...
GridLayout {
    ...
    Item {
        ...
        Kirigami.Icon {
            anchors.fill: parent
            anchors.topMargin: !isVertical ? thickMargin : 0
            anchors.bottomMargin: !isVertical ? thickMargin : 0
            anchors.leftMargin: isVertical ? thickMargin : 0
            anchors.rightMargin: isVertical ? thickMargin : 0
    ...
    CItem {
        ...
        PlasmaComponents.Label {
            ...
            font: Kirigami.Theme.font
            font.capitalization: cfg.isCaps ? Font.Capitalize : Font.MixedCase
            font.bold: cfg.isBold
            font.italic: cfg.isItalic
        }
    }
